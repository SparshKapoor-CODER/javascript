...
// the code in lines 3 to 11 is OK to use, but it's better to avoid it as it can lead to confusion and a clean code is always better.
// the code in lines 13 to 16 is not recommended to use, as it can lead to confusion and bugs.
